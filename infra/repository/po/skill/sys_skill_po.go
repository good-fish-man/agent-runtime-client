...
// SysSkill is the gorm persistence object mapped to table sys_skill.
...
// TableName maps to the shared sys_skill table.
func (po *SysSkill) TableName() string { return "sys_skill" }
