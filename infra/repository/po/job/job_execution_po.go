...
// JobExecutionPO is the gorm persistence object mapped to job_execution_log.
...
// TableName maps to the shared job_execution_log table.
func (po *JobExecutionPO) TableName() string { return "job_execution_log" }
