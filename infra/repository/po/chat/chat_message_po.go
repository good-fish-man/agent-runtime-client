...
type StringJSON struct{ Val string }
...
func (po *ChatMessage) TableName() string       { return "chat_message" }
func (po *ChatMessage) IsPendingApproval() bool { return po.Status == "pending_approval" }
