...
// SysKnowledgeBase is the gorm persistence object mapped to table sys_knowledge_base.
...
// TableName maps to sys_knowledge_base.
func (po *SysKnowledgeBase) TableName() string { return "sys_knowledge_base" }
