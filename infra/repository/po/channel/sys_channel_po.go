...
// SysChannel is the gorm persistence object mapped to table sys_channel.
type SysChannel struct {
	...
	Config      string `gorm:"column:config;type:text;comment:渠道配置;serializer:json" json:"config"`
}
...
// TableName maps to the shared sys_channel table.
func (po *SysChannel) TableName() string { return "sys_channel" }
