...
type Store interface {
	ApprovedArtifactVersions(context.Context, string) (entity.ArtifactVersions, error)
	...
	SaveCanaryMetric(context.Context, entity.CanaryMetric, *entity.Promotion, int64) error
