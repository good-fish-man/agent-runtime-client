...
type Store interface {
	...
	ApprovedSkills(context.Context, string) (map[string]bool, error)
	...
	ReviewCandidate(context.Context, string, string, string, string, string, int64) (*entity.Candidate, error)
	...
	ListSkills(context.Context, string, int) ([]entity.Skill, error)
	ListStrategies(context.Context, string, int) ([]entity.Strategy, error)
